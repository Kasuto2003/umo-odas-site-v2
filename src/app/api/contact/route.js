    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;">
          ...
          <div style="background:white;padding:24px;border:1px solid #E8EAFF;border-top:none;border-radius:0 0 12px 12px;">
            ...
            <div style="margin-top:20px;">
              <a href="mailto:${email}" style="background:#2129BF;color:white;padding:10px 24px;
